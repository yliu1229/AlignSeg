    ...
    def __init__(self,
        ...
        if self.mask_type is None:
            self.coco_train = UnlabelledCoco(self.file_list,
                                             ...
                                             os.path.join(self.data_dir, "images/train2017"))
            self.coco_val = UnlabelledCoco(self.file_list[:self.size_val_set * self.batch_size],
                                           self.val_transforms,
                                           os.path.join(self.data_dir, "images/val2017"))
        else:
...
class COCOSegmentation(VisionDataset):
    ...
    def __init__(
        ...
        if mask_type == "all":
            seg_folder = "annotations/stuffthingmaps_trainval2017/{}2017/"
            json_file = "annotations/stuffthingmaps_trainval2017/stuffthing_2017.json"
        ...
        with open(os.path.join(root, json_file)) as f:
            ...
            if mask_type == "all":
                ...
                self.cat_id_map = {(cat_dict['id']-1): super_cat_to_id[cat_dict['supercategory']] for cat_dict in all_cat}
            elif mask_type == "thing":
    ...
    def __getitem__(self, index: int) -> Tuple[Any, Any]:
        ...
        if self.mask_type == "all":
            # move 'id' labels from [0, 182] to [0,26], and 255=={182,255}
